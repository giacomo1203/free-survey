							...
							<div class="grouped fields">
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="1" <?php if($p17[0]=="1"){ echo "checked"; } ?>>
										<label>Office of Transport Security</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="2" <?php if($p17[0]=="2"){ echo "checked"; } ?>>
										<label>Department of Environment</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="3" <?php if($p17[0]=="3"){ echo "checked"; } ?>>
										<label>Department of Finance</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="4" <?php if($p17[0]=="4"){ echo "checked"; } ?>>
										<label>Department of Health</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="5" <?php if($p17[0]=="5"){ echo "checked"; } ?>>
										<label>Digital Transformation Office</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="6" <?php if($p17[0]=="6"){ echo "checked"; } ?>>
										<label>Infrastructure Australia</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="7" <?php if($p17[0]=="7"){ echo "checked"; } ?>>
								...
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q17" id="q17" value="8" <?php if($p17[0]=="8"){ echo "checked"; } ?>>
										<label>Other</label>
									</div>
								</div>
					...
					<div class="ui segment">
						<div class="ui form">
							<div class="grouped fields">
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q18" id="q18" value="1" <?php if($p18[0]=="1"){ echo "checked"; } ?>>
										<label>Representatives of the insurance industry</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q18" id="q18" value="2" <?php if($p18[0]=="2"){ echo "checked"; } ?>>
										<label>Representatives of the finance industry</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q18" id="q18" value="3" <?php if($p18[0]=="3"){ echo "checked"; } ?>>
										<label>Port/airport operators</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q18" id="q18" value="4" <?php if($p18[0]=="4"){ echo "checked"; } ?>>
										<label>Private laboratories/certification agencies</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q18" id="q18" value="5" <?php if($p18[0]=="5"){ echo "checked"; } ?>>
										<label>Other</label>
									</div>
								</div>
					...
					<div class="ui segment">
						<div class="ui form">
							<div class="grouped fields">
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="1" <?php if($p21[0]=="1"){ echo "checked"; } ?>>
										<label>Permanent consultative committees</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="2" <?php if($p21[0]=="2"){ echo "checked"; } ?>>
										<label>Centres of excellence or expertise</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="3" <?php if($p21[0]=="3"){ echo "checked"; } ?>>
										<label>Network of subject-matter experts</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="4" <?php if($p21[0]=="4"){ echo "checked"; } ?>>
										<label>Peer-to-peer groups</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="5" <?php if($p21[0]=="5"){ echo "checked"; } ?>>
										<label>Implementation working parties</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="6" <?php if($p21[0]=="6"){ echo "checked"; } ?>>
										<label>Conferences</label>
									</div>
								</div>
								<div class="field">
									<div class="ui checkbox">
										<input type="checkbox" name="q21" id="q21" value="7" <?php if($p21[0]=="7"){ echo "checked"; } ?>>
										<label>Other</label>
									</div>
								</div>
